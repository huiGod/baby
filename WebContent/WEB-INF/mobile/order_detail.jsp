            ...
            <div class="toolbar _fm-f-14">
                <div class="toolbar-inner _fm-block _fm-rel _fm-overhide">
                  <c:if test="${order.status==1}">
                    <span class="do or orderPay">立即支付</span>
                    <span class="do cancelOrder">取消订单</span>
                  </c:if>
                  <c:if test="${order.status!=1}">
                    <span class="dis orderPay">立即支付</span>
                  </c:if>
                </div>
            </div>
        </div>
...
==================================================-->
    ...
    <script type="text/javascript">
		...
		$(".cancelOrder").click(function(){
			var orderNo="${order.orderNo}";
       		location.href="<%=path %>/goods/cancel4Detail.do?orderNo="+orderNo;
    	});
    </script>
</body>
