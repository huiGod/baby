...
<html lang="zh-CN">
  <head>
    ...
    <title>唯优品</title>
    <link rel="stylesheet" href="<%=path %>/css/UUMall/framework7.ios.min.css?r="+Math.random()>
    <link rel="stylesheet" href="<%=path %>/css/UUMall/goods-info.css?r="+Math.random()>
  </head>
      ...
      <div class="view view-main">
        <div class="navbar">
          <div class="navbar-inner">
            ...
            <div class="right">
              <a href="<%=path%>/goods/toShop.do" class="link icon-only external"><i class="icon icon-car"><span class="badge bg-red" id="shopCarNum"></span></i></a>
            </div>
          </div>
        </div>
        <!-- Pages 内容区-->
              ...
              <div class="tabs-animated-wrap">
                <div class="tabs">
                      ...
                      <div class="recommentForU">
                        ...
                        <ul>
                          ...
                          <li class="recommentLi">
                            <a class="external" href="<%=path%>/goods/goodsInfo.do?id=${rec.id}"><div class="goodPicBox"><img src="${rec.previewImgUrl}"></div>
  	                          <div class="describ">
                  ...
                  <div id="tab3" class="tab" style="height:100%;overflow:hidden;"> 
                    <iframe src="<%=path %>/goods/toevaluation.do?id=${goods.id}" height="100%" width="100%" frameborder="0"></iframe>
                  </div>
                </div>
              </div>     
            </div>
                ...
                <div id="pop-GoodsContent">
                  ...
                  <div class="clearfix pop-selNum">
                    ...
                    <div class="rdc-add clearfix fr rdc-add2">
                      ...
                      <i class="numbers"><input disabled="disabled" type="tel" maxlength="3" value="1" class="input-num"></i>  
