...
<body class="shoppingcar-index">
    ...
    <div class="views">
        <div class="view view-main _js-shoppingCarList" data-addr="<%=path %>/goods/editShop.do">
            <div class="pages navbar-through toolbar-through">
                <div class="page" data-page="index">
                    <div style="top:-45px;" class="page-content pull-to-refresh-content _js-dropdownRefresh _js-limitdrag" data-ptr-distance="55">
                        <!-- 下拉刷新 -->
                        <div class="pull-to-refresh-layer">
                            <div class="preloader"></div>
                            <div class="pull-to-refresh-arrow" style="display:none;"></div>
                        </div>
                        <!-- 页面主体 -->
                        <div class="cus-page">
                            <div class="cus-page-inner">
                                <ul class="car-list" data-addr="<%=path%>/goods/tonice.do">
            ...
            <div class="toolbar _fm-f-18">
                <div class="toolbar-inner _fm-block _fm-rel _fm-overhide">
                    ...
                    <span class="count-all _fm-right _fm-txtcenter _fm-f-18 do" data-op="deleteMulti" data-addr="" data-next="<%=path%>/goods/shopBuy.do">结算</span>
